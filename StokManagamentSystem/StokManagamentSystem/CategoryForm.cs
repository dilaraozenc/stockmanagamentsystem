...
namespace StokManagamentSystem
{
    public partial class CategoryForm : Form
    {
        ...
        private void dgvCategory_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                CategoryModuleForm formModule = new CategoryModuleForm();
                formModule.lblCatId = dgvCategory.Rows[e.RowIndex].Cells[0].Value.ToString();
            ...
            else if (colName == "Delete")
            {
                ...
                {
                    con.Open();
                    SqlCommand cm = new SqlCommand("DELETE FROM tbCategory WHERE catid LIKE ", con); dgvCategory.Rows[e.RowIndex].Cells[0].Value.ToString();
                    cm.ExecuteNonQuery();
                    con.Close();
